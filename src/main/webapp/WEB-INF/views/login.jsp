...
<form:form method="post" modelAttribute="userForm" action="${login}">
	<form:input path="id" id="formId" type="text" />
	<form:input path="fbId" id="formFbId" type="text" />
	<form:input path="email" id="formEmail" type="text" />
	<form:input path="firstName" id="formFirstName" type="text" />
	<form:input path="lastName" id="formLastName" type="text" />
	<form:input path="latitude" id="formLatitude" type="text" />
	<form:input path="longitude" id="formLongitude" type="text" />
	<form:input path="zoom" id="formZoom" type="text" />
	<form:button type="submit" id="saveButton" hidden="true">Save</form:button>
</form:form>
